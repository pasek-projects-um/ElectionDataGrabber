...
PROFILES: dict[str, StateExpansionProfile] = {
    ...
    "AK": StateExpansionProfile("AK","state/election-region","election_region","statewide_results",1,("state_results","pdf","csv")),
    ...
    "NY": StateExpansionProfile("NY","county+board-of-elections","county_board","central_county_boards",58,("scytl","clarity","pdf")),
